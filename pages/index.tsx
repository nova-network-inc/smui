			...
			<Grid container component='main' sx={{ height: '100vh' }}>
				...
				<Grid item
					...
					>
						...
						<Typography component='h6'>Nova Network</Typography>
						<Typography component='h1' variant='h5'>Smart Contract Interface</Typography>
						<Box component='div' sx={{
							...
							<Typography sx={{ mt: 5 }} variant='body2' color='text.secondary' align='center'>
								© Nova Network - {' '}
								<Link color='inherit' href='https://novanetwork.io/'>
									novanetwork.io
								</Link>
							</Typography>
						</Box>
